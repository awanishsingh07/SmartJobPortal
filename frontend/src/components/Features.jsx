    ...
    <section className="bg-gray-900 w-full py-20">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="relative mt-12 md:mt-0 md:w-1/2 flex justify-center">
          <div className="w-[320px] h-[320px] rounded-full border-[3px] border-blue-600 bg-gradient-to-r from-gray-800 to-gray-900 flex items-center justify-center relative">
            {/* Center Logo */}
